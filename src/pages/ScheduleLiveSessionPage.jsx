...
const ScheduleLiveSessionPage = () => {
  ...
  const validateForm = () => {
    ...
    if (!startTime) errors.startTime = 'L\'heure de début est requise.';
    ...
    if (sessionType === 'courseSpecific' && !courseId) {
      errors.courseId = 'Veuillez sélectionner un cours.';
    }
  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      ...
      <p className="text-gray-600 mb-8">Créez et configurez votre prochaine session d'enseignement en direct.</p>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center space-x-4">
              <label className="inline-flex items-center">
                ...
                />
                <span className="ml-2 text-gray-700">Session Live Générale</span>
              </label>
              <label className="inline-flex items-center">
                <input
                  type="radio"
                ...
                />
                <span className="ml-2 text-gray-700">Live Spécifique à un Cours</span>
              </label>
            </div>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-500 text-xs italic mt-1">
              Cette URL sera utilisée pour rejoindre la session live. Si vide, une URL sera générée.
            </p>
          </div>
