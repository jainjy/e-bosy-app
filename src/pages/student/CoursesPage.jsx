...
const CoursesPage = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const [categoriesData, categoriesError] = await getData(
          "courses/categories"
        );
  ...
  if (error) {
    return (
      <div
        className={
          "min-h-screen bg-gray-50  flex items-center justify-center " + user
            ? "pt-8"
            : "mt-11"
        }
      >
  ...
  return (
    <>
      {!user && <Navbar />}
      <div className={"min-h-screen bg-gray-50 " + (user ? "pt-8" : "mt-11")}>
        <main className="container mx-auto p-8">
          <div className={"text-center mb-10"}>
            ...
            <p className="text-lg text-gray-600">
              Découvrez le cours parfait pour améliorer vos compétences et
              ...
              <h3 className="text-lg font-semibold text-gray-800 mb-4 flex items-center gap-2">
                ...
                >
                  <path
                    ...
                    d="M12 3c2.75 0 5 2.25 5 5S14.75 13 12 13 7 10.75 7 8 9.25 3 12 3Z"
                  />
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M12 15a7 7 0 0 0-7 7h14a7 7 0 0 0-7-7Z"
                  />
                </svg>
                Filtres
              </h3>
