    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto p-8 text-center mt-10">
        ...
        <p className="mt-4 text-xl text-gray-600">
          Decouvrez des cours en ligne de qualite, crees par des experts passionnes
        </p>
        ...
        {/* Section "Pourquoi choisir e-BoSy ?" based on Capture d'ecran 2025-05-29 115729.png */}
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
              ...
              <h4 className="text-xl font-semibold text-gray-800 mb-2">Cours de qualite</h4>
              <p className="text-gray-700 text-center">
                Des cours crees par des experts dans leur domaine avec du contenu mis à jour regulièrement.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
              ...
              <h4 className="text-xl font-semibold text-gray-800 mb-2">Communaute active</h4>
              <p className="text-gray-700 text-center">
                Rejoignez une communaute d'apprenants motives et echangez avec vos pairs.
              </p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center">
              ...
              <p className="text-gray-700 text-center">
                Obtenez des certificats valides à la fin de vos formations pour valoriser vos competences.
              </p>
            </div>
          </div>
        </div>

        {/* Section for course listings (optional, but seen in Capture d'ecran 2025-05-29 115758.png) */}
        <div className="mt-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-left">
              ...
              <p className="text-gray-600 text-sm mb-4">Apprenez les bases de JavaScript de zero</p>
            ...
            {/* Example Course Card: React pour debutants */}
            <div className="bg-white p-6 rounded-lg shadow-md text-left">
              <div className="bg-gray-200 h-40 rounded-md mb-4 flex items-center justify-center">
                <span className="text-gray-500">Image du cours</span>
              </div>
              <h4 className="text-xl font-semibold text-gray-800 mb-2">React pour debutants</h4>
              <p className="text-gray-600 text-sm mb-4">Maîtrisez React et creez vos premières applications</p>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-left">
              ...
              <p className="text-gray-600 text-sm mb-4">Developpez des APIs robustes avec Node.js</p>
